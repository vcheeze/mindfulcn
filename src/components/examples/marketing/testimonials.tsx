...
const testimonials = [
  {
    ...
    image: '/examples/avatars/person-2.webp',
  },
  {
    name: 'Sophie Tan',
    role: 'UX Researcher',
    image: '/examples/avatars/person-1.webp',
  },
  {
    name: 'Emily Carter',
    role: 'Product Manager',
    image: '/examples/avatars/person-3.webp',
  },
  {
    name: 'Hannah Lee',
    role: 'Software Engineer',
    image: '/examples/avatars/person-6.webp',
  },
]
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-9 md:flex-row">
            <blockquote className="text-3xl tracking-tight text-balance lg:text-4xl">
              Our team at Logoipsum has seen a huge boost in productivity since
              adopting Acme Inc. Designers, developers, and PMs are all working
