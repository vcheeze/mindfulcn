...
export function Cards() {
  return (
    <div className="@container w-full">
      <div className="grid items-start p-2 **:data-[slot=card]:shadow-none md:p-4 md:pt-1 @3xl:gap-4 @5xl:grid-cols-10 @7xl:grid-cols-11">
        <p className="text-muted-foreground col-span-full mb-2 text-xs">
          Cards from{' '}
          <a
          ...
          , originally{' '}
          <a
            href="https://ui.shadcn.com/examples/cards"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-foreground underline underline-offset-4"
          >
